...
object MyTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val trainData = MLUtils.loadLibSVMFile(sc, "data/sentimentClassification/trainFile")
    val testData = MLUtils.loadLibSVMFile(sc, "data/sentimentClassification/testFile")
